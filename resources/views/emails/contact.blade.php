...
<![endif]-->
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:100% !important; width:100%; height:auto !important;" width="700" alt="" data-proportionally-constrained="false" data-responsive="true" src="http://cdn.mcauto-images-production.sendgrid.net/1dee862b4b9b6ebf/5b315714-3cd6-4717-bb65-0091f0cc8e30/1920x603.jpg">
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:20px 0px 20px 0px; line-height:24px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 24px"><strong>{{$title}}</strong></span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:0px 0px 25px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center">Salutation</div>
<div style="font-family: inherit; text-align: center">{!! $data !!}</div><div></div></div></td>
      </tr>
    </tbody>
  ...
  </table><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:7px 10px 12px 10px;" bgcolor="#849ffd" data-distribution="1">
    <tbody>
      <tr role="module-content">
      ...
      <tbody>
        <tr>
          <td style="padding:0px;margin:0px;border-spacing:0;"><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="547fd1c6-d042-4c03-8fd3-7232534cc9ed.1.1" data-mc-module-version="2019-10-22">
    <tbody>
      <tr>
        <td style="padding:5px 40px 0px 40px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 16px; color: #000000">Ceci est un message automatisé, veuillez ne pas répondre</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table></td>
        </tr>
  ...
  </table><table class="module" role="module" data-type="social" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="ba691f5e-d4a0-4a11-9902-e8a2c17b6a55">
    <tbody>
      <tr>
        <td valign="top" style="padding:40px 0px 0px 0px; font-size:6px; line-height:10px;" align="center">
          <table align="center" style="-webkit-margin-start:auto;-webkit-margin-end:auto;">
            <tbody><tr align="center"><td style="padding: 0px 5px;" class="social-icon-column">
      <a role="social-icon-link" href="https://www.facebook.com/sendgrid/" target="_blank" alt="Facebook" title="Facebook" style="display:inline-block; background-color:#3B579D; height:25px; width:25px; border-radius:50px; -webkit-border-radius:50px; -moz-border-radius:50px;">
      ...
      <a role="social-icon-link" href="https://www.instagram.com/sendgrid/" target="_blank" alt="Instagram" title="Instagram" style="display:inline-block; background-color:#7F4B30; height:25px; width:25px; border-radius:50px; -webkit-border-radius:50px; -moz-border-radius:50px;">
      ...
      <a role="social-icon-link" href="https://www.pinterest.com/sendgrid/" target="_blank" alt="Pinterest" title="Pinterest" style="display:inline-block; background-color:#CB2027; height:25px; width:25px; border-radius:50px; -webkit-border-radius:50px; -moz-border-radius:50px;">
      ...
      <a role="social-icon-link" href="https://www.linkedin.com/company/sendgrid/" target="_blank" alt="LinkedIn" title="LinkedIn" style="display:inline-block; background-color:#0077B5; height:25px; width:25px; border-radius:50px; -webkit-border-radius:50px; -moz-border-radius:50px;">
